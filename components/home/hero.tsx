      ...
      <section className="relative overflow-hidden py-24 sm:py-32">
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="mx-auto max-w-7xl text-center">
            ...
            >
              Exploring cutting-edge research in Application Development, Machine Learning, Blockchain, IoT, and
              emerging technologies that shape the future of cyber-physical systems.
            </motion.p>
          ...
          >
            <div className="text-center">
              <p className="text-sm text-muted-foreground mb-6">Our Research Focus</p>
              <div className="flex flex-wrap items-center justify-center gap-4">
                {["Application Development", "Machine Learning", "Blockchain", "IoT", "Cyber-Physical Systems"].map(
                  (area) => (
                    <div
                      key={area}
                      className="px-4 py-2 rounded-full border border-border/50 bg-background/50 text-sm text-muted-foreground hover:text-foreground hover:border-primary/50 transition-all duration-300"
                    >
                      {area}
                    </div>
                  ),
