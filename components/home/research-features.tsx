...
export default function ResearchFeatures() {
  ...
  const [baseColor, setBaseColor] = useState<[number, number, number]>([0.11, 0.53, 0.89]) // #1E88E5 in RGB normalized
  const [glowColor, setGlowColor] = useState<[number, number, number]>([0.11, 0.53, 0.89]) // #1E88E5 in RGB normalized

  const [dark, setDark] = useState<number>(theme === "dark" ? 1 : 0)

  useEffect(() => {
    setBaseColor([0.11, 0.53, 0.89]) // #1E88E5
    setGlowColor([0.11, 0.53, 0.89]) // #1E88E5
  ...
  return (
    <section id="research-features" className="text-foreground relative overflow-hidden py-12 sm:py-24 md:py-32">
        ...
        >
          <div className="cursor-none">
            <div className="grid grid-cols-12 gap-4 md:gap-6 justify-center">
              ...
              <motion.div
                className="group border-secondary/40 text-card-foreground relative col-span-12 flex flex-col overflow-hidden rounded-xl border-2 p-4 sm:p-6 shadow-xl transition-all ease-in-out md:col-span-6 xl:col-span-6 xl:col-start-2"
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">💻 Application Development</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Building scalable and efficient applications using modern frameworks and best practices for
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="flex items-center gap-8">
                        ...
                        <div className="flex flex-col gap-3">
                          {["React", "Node.js", "TypeScript"].map((item, index) => (
                            <motion.div
                              key={`left-${index}`}
                        ...
                        {/* Center Logo */}
                        <motion.div
                          className="w-16 h-16 border border-gray-300 rounded-lg overflow-hidden shadow-lg bg-white flex items-center justify-center"
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">🤖 Machine Learning</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Developing intelligent systems and algorithms for pattern recognition, prediction, and autonomous
                      decision-making.
                    </p>
                  </div>
                </div>
                  ...
                  <h1 className="mt-8 text-center text-5xl leading-[100%] font-semibold sm:leading-normal lg:mt-12 lg:text-6xl">
                    <span className='bg-background relative mt-3 inline-block w-fit rounded-md border px-1.5 py-0.5 before:absolute before:top-0 before:left-0 before:z-10 before:h-full before:w-full before:bg-[url("/noise.gif")] before:opacity-[0.09] before:content-[""]'>
                      <ScrambleHover
                        ...
                        className="cursor-pointer bg-gradient-to-t from-[#1E88E5] to-[#1E88E5] bg-clip-text text-transparent"
              ...
              >
                <div className="flex flex-col gap-4">
                  ...
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Exploring distributed ledger technologies and decentralized systems for secure and transparent
                      applications.
                    </p>
                  </div>
                </div>
                    ...
                    <div className="relative rounded-2xl border border-white/10 bg-black/20 dark:bg-white/5 backdrop-blur-sm">
                      <div className="p-4">
                        <textarea
                          ...
                          placeholder="Explore blockchain networks..."
                          value={inputValue}
                      ...
                      <div className="flex items-center justify-between px-4 pb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <button className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#1E88E5] hover:bg-[#1E88E5]/90 transition-colors text-white font-medium">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="16"
                              height="16"
              ...
              >
                <div className="flex flex-col gap-4">
                  <h3 className="text-2xl leading-none font-semibold tracking-tight">📡 IoT & Sensor Networks</h3>
                  <div className="text-md text-muted-foreground flex flex-col gap-2 text-sm">
                    <p className="max-w-[460px]">
                      Integrating physical devices with digital systems for real-time data collection and analysis.
                    </p>
                  </div>
                </div>
                <div className="flex grow items-center justify-center select-none relative min-h-[300px] p-4">
                  <div className="relative w-full max-w-sm">
                    <div className="grid grid-cols-3 gap-4">
                      {[1, 2, 3, 4, 5, 6].map((i) => (
                        <motion.div
                          key={i}
                          className="aspect-square rounded-lg bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/30 flex items-center justify-center"
                          animate={isFeature4Hovering ? { scale: [1, 1.1, 1] } : { scale: 1 }}
                          transition={{
                            duration: 2,
                            delay: i * 0.1,
