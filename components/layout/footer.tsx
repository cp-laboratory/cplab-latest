    ...
    <footer className="relative border-t border-white/5 bg-[hsl(222_47%_4%)]">
      ...
      <div className="container-xl py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          {/* Navigation */}
          <div>
            <h3 className="font-semibold text-white text-sm uppercase tracking-wider mb-4">Navigation</h3>
          ...
          {/* Research Areas */}
          <div>
            <h3 className="font-semibold text-white text-sm uppercase tracking-wider mb-4">Research</h3>
            <ul className="space-y-2.5">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {footerLinks.quickLinks.map((link) => (
                <li key={link.label}>
                  <Link href={link.href} className="text-sm text-white/50 hover:text-white transition-colors flex items-center gap-1.5 group">
                    {link.label}
