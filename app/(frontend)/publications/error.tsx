      ...
      <div className="relative z-10 container mx-auto px-4 py-24 text-center">
        ...
        >
          <div className="mb-8">
            ...
            <h1 className="text-4xl font-bold text-foreground mb-4">Error Loading Publications</h1>
            <p className="text-lg text-muted-foreground mb-8">
              We encountered an error while loading the publications. Please try again.
            </p>
          </div>
